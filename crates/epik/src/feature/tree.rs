...
/// A value and the subtrees beneath it. Wire vocabulary: it serializes
/// on its way to a model or a window, and a window reads it back in as
/// the shape of the build it watches.
